...
class CVFilter:
    ...
    def Filter_state_covariance(self, measurements, current_time):
        ...
        for measurement in measurements:
            ...
            # Calculate predicted state vector elements
            fx = self.Sf[0][0] + self.Sf[3][0] * dt
            fy = self.Sf[1][0] + self.Sf[4][0] * dt
            fz = self.Sf[2][0] + self.Sf[5][0] * dt
            fvx = self.Sf[3][0]
            fvy = self.Sf[4][0]
            fvz = self.Sf[5][0]
            ...
            # Print filtered state vector elements
            print("Filtered State Vector Elements:")
            print("fx:", self.Sf[0][0])
            print("fy:", self.Sf[1][0])
            print("fz:", self.Sf[2][0])
            print("fvx:", self.Sf[3][0])
            print("fvy:", self.Sf[4][0])
            print("fvz:", self.Sf[5][0])
